...
{
    ms_load_id = VER_LOAD_REQ_LANG(M_SLCT_CMN_PK2, LOAD_ADDRESS_12);
...
void MsLoadCtrl(u_char mode)
{
    ...
    {
    case MS_MODE_SLCT:
        ms_load_id = LoadReq(EFF001_PK2, LOAD_ADDRESS_45);
        ms_load_id = VER_LOAD_REQ_LANG(M_SLCT_FSM_PK2, LOAD_ADDRESS_13);
    break;
    case MS_STORY_MODE:
        ingame_wrk.game = 0;

        ms_load_id = VER_LOAD_REQ_LANG(M_SLCT_STY_PK2, LOAD_ADDRESS_13);
    ...
    case MS_BATTLE_MODE:
        ...
        ms_load_id = VER_LOAD_REQ_LANG(M_SLCT_BTL_PK2, LOAD_ADDRESS_13);
        ms_load_id = VER_LOAD_REQ_LANG(M_SLCT_BTL_CHR_PK2, LOAD_ADDRESS_15);
    break;
    case MS_OPTION:
        ms_load_id = VER_LOAD_REQ_LANG(M_SLCT_OPT_PK2, LOAD_ADDRESS_13);
        ms_load_id = VER_LOAD_REQ_LANG(PL_OPTI_PK2, LOAD_ADDRESS_18);
        ms_load_id = VER_LOAD_REQ_LANG(PL_STTS_PK2, LOAD_ADDRESS_30);
    break;
    case MS_SOUND_TEST:
        ms_load_id = VER_LOAD_REQ_LANG(M_SLCT_SND_PK2, LOAD_ADDRESS_13);
    break;
    case MS_MISSION_SELECT:
        if (cmn_tex_load == 0)
        {
        ...
        ms_load_id = VER_LOAD_REQ_LANG(M_SLCT_BTL_MSN_PK2, LOAD_ADDRESS_17);
    break;
    case MS_CAMERA:
        CameraCustomInit();
        OutGameInitCamera();

        ms_load_id = LoadReq(PL_BGBG_PK2, LOAD_ADDRESS_31);
        ms_load_id = VER_LOAD_REQ_LANG(PL_MTOP_PK2, LOAD_ADDRESS_32);
        ms_load_id = VER_LOAD_REQ_LANG(PL_STTS_PK2, LOAD_ADDRESS_30);
        ms_load_id = VER_LOAD_REQ_LANG(PL_CAME_PK2, LOAD_ADDRESS_45);
    break;
#if defined(BUILD_US_VERSION) || defined(BUILD_EU_VERSION)
    case MS_PHOT:
        ms_load_id = LoadReq(PL_BGBG_PK2, LOAD_ADDRESS_31);
        ms_load_id = VER_LOAD_REQ_LANG(PL_MTOP_PK2, LOAD_ADDRESS_32);
        ms_load_id = VER_LOAD_REQ_LANG(PL_STTS_PK2, LOAD_ADDRESS_30);
        ms_load_id = VER_LOAD_REQ_LANG(PL_PHOT_PK2, LOAD_ADDRESS_35);
