...
int InGameFirstLoad(void)
{
    ...
    case INGAME_INIT_LOAD_MENU:
        init_load_id = VER_LOAD_REQ_LANG(PL_SMAP_PK2, LOAD_ADDRESS_38);
        init_load_id = LoadReq(PL_PLAY_PK2, LOAD_ADDRESS_39);
        init_load_id = VER_LOAD_REQ_LANG(PL_STTS_PK2, LOAD_ADDRESS_27);
        init_load_id = LoadReq(PL_BGBG_PK2, LOAD_ADDRESS_28);
        init_load_id = VER_LOAD_REQ_LANG(PL_PLDT_PK2, LOAD_ADDRESS_30);
        init_load_id = VER_LOAD_REQ_LANG(PL_MTOP_PK2, LOAD_ADDRESS_29);
        init_load_id = VER_LOAD_REQ_LANG(N_LOAD_PK2, LOAD_ADDRESS_45);
    ...
    case INGAME_INIT_LOAD_EFCT:
        init_load_id = LoadReq(HAND_PK2, LOAD_ADDRESS_47);
        init_load_id = LoadReq(EFF001_PK2, LOAD_ADDRESS_42);
    ...
    case INGAME_INIT_WAIT_EFCT:
        ...
        SetETIM2File(LOAD_ADDRESS_42);

        sys_wrk.load_mode = INGAME_INIT_LOAD_CAME;
    // case fall-through
    case INGAME_INIT_LOAD_CAME:
        init_load_id = LoadReq(ENEDMG_PK2, LOAD_ADDRESS_46);
    ...
    case INGAME_INIT_LOAD_PHOTO:
        init_load_id = LoadReq(PHOTO001_PK2, LOAD_ADDRESS_41);
    ...
    case INGAME_INIT_LOAD_FNDR:
        init_load_id = VER_LOAD_REQ_LANG(PL_FNDR_PK2, LOAD_ADDRESS_34);
        init_load_id = VER_LOAD_REQ_LANG(PL_LIFE_PK2, LOAD_ADDRESS_37);
