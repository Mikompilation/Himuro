...
int InGameFirstLoad(void)
{
    ...
    case INGAME_INIT_LOAD_MENU:
        init_load_id = VER_LOAD_REQ_LANG(PL_SMAP_PK2, LOAD_ADDRESS_41);
        init_load_id = LoadReq(PL_PLAY_PK2, LOAD_ADDRESS_42);
        init_load_id = VER_LOAD_REQ_LANG(PL_STTS_PK2, LOAD_ADDRESS_30);
        init_load_id = LoadReq(PL_BGBG_PK2, LOAD_ADDRESS_31);
        init_load_id = VER_LOAD_REQ_LANG(PL_PLDT_PK2, LOAD_ADDRESS_33);
        init_load_id = VER_LOAD_REQ_LANG(PL_MTOP_PK2, LOAD_ADDRESS_32);
        init_load_id = VER_LOAD_REQ_LANG(N_LOAD_PK2, LOAD_ADDRESS_48);
    ...
    case INGAME_INIT_LOAD_EFCT:
        init_load_id = LoadReq(HAND_PK2, LOAD_ADDRESS_50);
    ...
    case INGAME_INIT_LOAD_CAME:
        init_load_id = LoadReq(ENEDMG_PK2, LOAD_ADDRESS_49);
    ...
    case INGAME_INIT_LOAD_PHOTO:
        init_load_id = LoadReq(PHOTO001_PK2, LOAD_ADDRESS_44);
    ...
    case INGAME_INIT_LOAD_FNDR:
        init_load_id = VER_LOAD_REQ_LANG(PL_FNDR_PK2, LOAD_ADDRESS_37);
        init_load_id = VER_LOAD_REQ_LANG(PL_LIFE_PK2, LOAD_ADDRESS_40);
