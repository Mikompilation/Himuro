...
#define IOPRP_IMAGE_FILE "cdrom0:\\IOPRP224.IMG;1"
#elif defined(BUILD_US_VERSION)
#define IOPRP_IMAGE_FILE "cdrom0:\\IOPRP224.IMG;1"
#elif defined(BUILD_EU_VERSION)
#define IOPRP_IMAGE_FILE "cdrom0:\\IOPRP23.IMG;1"
#endif
...
static void LoadDefModule()
{
    while (!sceSifRebootIop(IOPRP_IMAGE_FILE)) {};
    while (!sceSifSyncIop()) {};
}
...
void vfunc()
{
    ...
    *REG_RCNT1_COUNT = 0;
    ...
    if (sys_wrk.count & 1)
    {
        ...
        sceGsSetHalfOffset(&g_db.draw0, 0x800, 0x800, (odev + 1) & 1);
    }
    else
    {
        pdrawenv = &g_db.draw0;

        sceGsSetHalfOffset(&g_db.draw1, 0x800, 0x800, (odev + 1) & 1);
    }
