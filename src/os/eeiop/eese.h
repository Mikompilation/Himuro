...
int SeStartPosFlame(int se_no, u_short flame, u_short vol_max, u_short pitch, u_char room_id);
int SeStartPut(int se_no, u_short fin_spd, u_short vol_max, u_short pitch, u_char room_id);
int SeStartPutFlame(int se_no, u_short flame, u_short vol_max, u_short pitch, u_char room_id);
...
int SeStartPosSrundFlame(u_char room_id, u_short flame, u_short vol_max, u_short pitch);
int SeStartPosEventFlame(u_char room_id, u_char req_pos, u_short flame, u_short vol_max, u_short pitch);
int SeStopAll();
...
int SeStartCmn(int se_no, float *mb, int fin_spd, u_short vol_max);
void SeStartVpCmn(int se_no, int vpos, float *mb, int fin_spd, u_short vol_max);
u_char SeGetFreeSv();
