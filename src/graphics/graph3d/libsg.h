...
static inline void calc_skinned_data(sceVu0FVECTOR *dp, float *m, float *n)
{
    asm volatile("                             \n\
        ...
        vmove.w         $vf15, $vf0            \n\
        lqc2            $vf12, 0(%2)           \n\
        vmulax.xyz      ACC,   $vf4,    $vf12x \n\
        vmadday.xyz     ACC,   $vf5,    $vf12y \n\
        vmaddz.xyz      $vf13, $vf6,    $vf12z \n\
        vsubw.w         $vf14, $vf0,    $vf12  \n\
        lqc2            $vf12, 0x10(%2)        \n\
        vmulax.xyz      ACC,   $vf8,    $vf12x \n\
        vmadday.xyz     ACC,   $vf9,    $vf12y \n\
        vmaddz.xyz      $vf14, $vf10,   $vf12z \n\
        vmulaw.xyz      ACC,   $vf13,   $vf13w \n\
        vmaddw.xyz      $vf12, $vf14,   $vf14w \n\
        vmulw.xyz       $vf12, $vf12,   $vf7w  \n\
        vmove.w         $vf12, $vf0            \n\
        sqc2            $vf15, 0(%0)           \n\
        sqc2            $vf12, 0x10(%0)        \n\
    ": :"r"(dp), "r"(m), "r"(n));
